...
@Component({
  selector: 'app-w-property-contact-us',
  templateUrl: './w-property-contact-us.component.html',
  styleUrls: ['./w-property-contact-us.component.scss']
})
export class WPropertyContactUsComponent {
