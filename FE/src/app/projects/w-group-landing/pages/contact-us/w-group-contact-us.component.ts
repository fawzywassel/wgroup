...
@Component({
  selector: 'app-w-group-contact-us',
  templateUrl: './w-group-contact-us.component.html',
  styleUrls: ['./w-group-contact-us.component.scss']
})
export class WGroupContactUsComponent {
  image = IMAGES.pagesHeaders.wGroup.contactUs
  title = "تواصل معنا";
